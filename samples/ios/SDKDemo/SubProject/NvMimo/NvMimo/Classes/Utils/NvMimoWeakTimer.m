...
#import <libkern/OSAtomic.h>
    ...
    #error NvWeakTimer is ARC only. Either turn on ARC for the project or use -fobjc-arc flag
#endif
...
@implementation NvMimoWeakTimer
...
+ (instancetype)scheduledTimerWithTimeInterval:(NSTimeInterval)timeInterval
                                 ...
                                 dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    NvMimoWeakTimer *timer = [[self alloc] initWithTimeInterval:timeInterval
                                                     target:target
                                                   selector:selector
                                                   userInfo:userInfo
                                                    repeats:repeats
...
- (void)schedule
{
    ...
    __weak NvMimoWeakTimer *weakSelf = self;
