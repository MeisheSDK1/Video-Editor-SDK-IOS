...
@interface NvBoomrangeGraphicBtn ()
...
@implementation NvBoomrangeGraphicBtn
...
+ (instancetype)buttonWithType:(UIButtonType)buttonType withTitle:(NSString *)title withImageNormal:(NSString *)normal withImageSelected:(NSString *)selected{
    NvBoomrangeGraphicBtn *btn = [NvBoomrangeGraphicBtn buttonWithType:buttonType];
    if (btn) {
