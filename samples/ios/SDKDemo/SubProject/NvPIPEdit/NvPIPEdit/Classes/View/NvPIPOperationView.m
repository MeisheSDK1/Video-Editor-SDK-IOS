...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.replaceButton.image = [NvBaseUtils imageNamed:@"pip-replace" inBundle:[NSBundle bundleForClass:[self class]]];
        ...
        self.zoomInButton.image = [NvBaseUtils imageNamed:@"pip-Magnifier-add" inBundle:[NSBundle bundleForClass:[self class]]];
        ...
        self.zoomOutButton.image = [NvBaseUtils imageNamed:@"pip-Magnifier-remove" inBundle:[NSBundle bundleForClass:[self class]]];
