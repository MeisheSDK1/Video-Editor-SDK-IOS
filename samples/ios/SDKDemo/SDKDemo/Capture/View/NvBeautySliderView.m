...
@interface NvBeautySlider : UISlider

@end
@implementation NvBeautySlider
...
- (void)refreshView {
    ...
    self.indicatorLabel.text = self.pointForamt ? [NSString stringWithFormat:self.pointForamt,paramSender.value] :[NSString stringWithFormat:@"%.f",paramSender.value*100];
