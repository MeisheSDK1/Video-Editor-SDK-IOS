...
@class NvColorSelectedControl;

NS_ASSUME_NONNULL_BEGIN
@protocol NvColorSelectedControlDelegate <NSObject>
...
@interface NvColorSelectedControl : UIControl

/// 代理 delegate
@property (weak, nonatomic) id<NvColorSelectedControlDelegate> delegate;

/// 视图的是否是垂直布局  Is the view vertical
