...
- (void)layoutSubviews {
    ...
    self.leftLabel.text = [NSString stringWithFormat:@"%.1fs",self.curMinValue];
    self.rightLabel.centerY = self.maxSliderBtn.top-20;
    self.rightLabel.text = [NSString stringWithFormat:@"%.1fs",1-self.curMaxValue];
}
...
- (UIButton *)minSliderBtn {
    if (!_minSliderBtn) {
        ...
        [_minSliderBtn setImage:[UIImage imageNamed:@"leftimage"] forState:UIControlStateNormal];
        [_minSliderBtn setImage:[UIImage imageNamed:@"leftimage"] forState:UIControlStateHighlighted];
...
- (UIButton *)maxSliderBtn {
    if (!_maxSliderBtn) {
        ...
        [_maxSliderBtn setImage:[UIImage imageNamed:@"rightimage"] forState:UIControlStateNormal];
        [_maxSliderBtn setImage:[UIImage imageNamed:@"rightimage"] forState:UIControlStateHighlighted];
