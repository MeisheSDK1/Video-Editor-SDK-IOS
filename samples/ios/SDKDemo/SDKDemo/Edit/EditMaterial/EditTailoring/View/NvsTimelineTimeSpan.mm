...
@implementation NvsTimelineTimeSpan {
    NvTimelineImageView* leftHandle;
    NvTimelineImageView* rightHandle;
...
- (void)initInternal {
    ...
    leftHandle = [[NvTimelineImageView alloc] initWithFrame:CGRectMake(-handleWidth, -2, handleWidth, self.bounds.size.height + 4)];
    ...
    rightHandle = [[NvTimelineImageView alloc] initWithFrame:CGRectMake(self.bounds.size.width-1, -2, handleWidth, self.bounds.size.height + 4)];
...
- (void)updateHandleFrame {
    ...
    leftHandle.frame = CGRectMake(0, 0, handleWidth, self.sequenceView.frame.size.height);
    rightHandle.frame = CGRectMake(frame.size.width- handleWidth, 0, handleWidth, self.sequenceView.frame.size.height);
