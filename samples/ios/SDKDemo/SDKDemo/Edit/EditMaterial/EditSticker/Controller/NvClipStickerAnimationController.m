//
//  NvClipStickerAnimationController.m
//  SDKDemo
//
...
@interface NvClipStickerAnimationController ()<NvLiveWindowPanelViewDelegate, NvsStreamingContextDelegate,NvAssetManagerDelegate,NvAnimationViewDelegate,NvAnimationSliderDelegate>
...
@implementation NvClipStickerAnimationController
...
- (void)playSticker:(NvsClipAnimatedSticker *)currentSticker animationType:(NvStickerAnimationType)type animationDuration:(int64_t)duration {
    int64_t inPoint;
    if (type == NvInStickerAnimationType) {
