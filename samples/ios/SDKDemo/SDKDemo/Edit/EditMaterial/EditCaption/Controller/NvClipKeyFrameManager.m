...
@implementation NvClipKeyFrameManager
       ...
       completeHandler:(void(^)(NvKeyframeInfo *keyModel, int index))handler
{
    ...
    /// 设置关键帧
    /// Set key frame
    if (type == NvClipKeyframe_Caption) {
        NvsClipCaption *captionFx = (NvsClipCaption *)fx;
      ...
      timelineVideoFx:(NvsFx *)fx
{
    ...
    if (type == NvClipKeyframe_CaptionControlPoint) {
        NvsClipCaption *captionFx = (NvsClipCaption *)fx;
        /// 再添加关键帧点对
        ...
        [source enumerateObjectsUsingBlock:^(NvKeyframeInfo * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            if (obj.opacity) {
                [captionFx setControlPoint:@"Track Opacity" controlPointPair:obj.translationPairY];
            }
...

{
    ...
    switch (attributeType) {
        ...
        case NvClipCaptionAttribute_Sacle:
            ...
            break;
        case NvClipCaptionAttribute_RotZ:
            array = @[@"Caption RotZ"];
            ...
            break;
        case NvClipCaptionAttribute_Opacity:
            array = @[@"Track Opacity"];
